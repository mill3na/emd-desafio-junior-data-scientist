...
open_os_specific_day = funcoes.executar_consulta(analise_sql.quantidade_chamados_dia)
open_os_specific_day = funcoes.extrair_substring_array(open_os_specific_day, "total_chamados_abertos")
...
order_by_type = funcoes.executar_consulta(analise_sql.maior_ocorrencia_por_tipo_dia_especifico)
order_by_type = funcoes.extrair_substring_array(order_by_type, "tipo")
...
bairros_mais_ocorrencias = funcoes.executar_consulta(analise_sql.bairros_com_mais_chamados_neste_dia)
...
subprefeitura_mais_chamados = funcoes.executar_consulta(analise_sql.subprefeitura_query)
...
chamado_sem_bairro_associado = funcoes.executar_consulta(analise_sql.chamados_bairros_nulos)
chamado_sem_bairro_associado = funcoes.extrair_substring_array(chamado_sem_bairro_associado, "quantidade")

chamado_sem_bairro_associado_na_data = funcoes.executar_consulta(analise_sql.chamados_bairros_nulos_na_data)
chamado_sem_bairro_associado_na_data = funcoes.extrair_substring_array(chamado_sem_bairro_associado_na_data, "quantidade")
...
tipo_chamado_bairro_nulo_na_data = funcoes.executar_consulta(analise_sql.tipo_chamado_bairro_nulo_na_data)
tipo_chamado_bairro_nulo_na_data = funcoes.extrair_substring_array(tipo_chamado_bairro_nulo_na_data, "tipo")
...
subtipo_especifico_na_data = funcoes.executar_consulta(analise_sql.subtipo_especifico_na_data)
subtipo_especifico_na_data = funcoes.extrair_substring_array(subtipo_especifico_na_data, "quantidade")
...
df_chamados_em_eventos = funcoes.executar_consulta(analise_sql.chamados_subtipo_abertos_eventos)
...
chamados_por_evento = funcoes.executar_consulta(analise_sql.chamados_por_evento)
eventos = funcoes.extrair_substring_array(chamados_por_evento, "evento")
quantidade_por_evento = funcoes.extrair_substring_array(chamados_por_evento, "quantidade_por_evento")
...
evento_maior_media_chamados = funcoes.executar_consulta(analise_sql.maior_media_por_evento)
evento_maior_media = funcoes.extrair_substring_array(evento_maior_media_chamados, "evento")
media = funcoes.extrair_substring_array(evento_maior_media_chamados, "media_diaria_chamados")
...
df_comparacoes_por_evento = funcoes.executar_consulta(analise_sql.comparacao_medias_diarias)
